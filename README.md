...
<title>Phiếu học tập Toán 11 - Chương 1 (Tổng hợp)</title>
</head>
<body style="font-family:'Segoe UI',sans-serif;background-color:#f5f7fa;margin:0;padding:0">
<h1 style="text-align:center;color:#004aad;margin-top:30px">
📘 PHIẾU HỌC TẬP TOÁN 11 – CHƯƠNG 1 (TỔNG HỢP)<br>
<small>Kết nối tri thức với cuộc sống</small>
</h1>
<hr style="margin:20px 0;border:none;border-top:2px solid #ddd">
<section style='margin:30px auto;max-width:1000px;background:#fff;border-radius:12px;box-shadow:0 2px 6px rgba(0,0,0,0.1);padding:20px'>
